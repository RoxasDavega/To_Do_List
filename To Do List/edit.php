       ...
       <div class="borderhome">
            ...
            <form method="POST" action="proses.php?action=edit">
                    ...
                    <div class = "row">
                        ...
                        <div class="col-5"><a class="btn btn-outline-primary" role="button" href="proses.php?action=deletetodo&id=<?= $row['id']; ?>" onclick="process.php?action=deletetodo&id=<?= $row['id']; ?>">Delete</a></button></div>
                    </div>
            </form>
