...
<div class="batas">
       <div class="borderhome">
            ...
            <form method="POST" action="process.php?action=edittodo">
                    ...
                    <div class = "row">
                        ...
                        <div class="col-5"><a class="btn btn-outline-primary" role="button" href="Delete.php?id=<?=$idtodo;?>" onclick="Delete.php">Delete</a></button></div>
                    </div>
            </form>
